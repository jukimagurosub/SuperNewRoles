...
namespace SuperNewRoles
{
    ...
    class AllRoleSetClass
    {
        ...
        if (!(CustomOption.CustomOptions.EvilHackerOption.getString().Replace("0%", "") == ""))
            {
                int OptionDate = int.Parse(CustomOption.CustomOptions.EvilHackerOption.getString().Replace("0%", ""));
                RoleId ThisRoleId = RoleId.EvilHacker;
                if (OptionDate == 10)
                {
                    Impoonepar.Add(ThisRoleId);
                }
